  ...
  render() {
    return (
      <div className="container">
        <div class={`row message ${this.props.read? "read": "unread"}`}>
          <div class="col-xs-1">
            <div class="row">
              <div class="col-xs-2">
                <input id={this.props.id} type="checkbox" className = {this.props.selected ? "":"checked"} onClick={(e) => this.props.selectMessage(this.props.id)}></input>
              </div>
              <div class="col-xs-2">
